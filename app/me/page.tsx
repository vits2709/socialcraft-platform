...
export default function MePage() {
  ...
  // username per link "Vedi profilo" pubblico
  ...
  async function loadAll(silent = false) {
    ...
    try {
      ...
      if (meJson?.ok) {
        setProfileUsername(meJson.user.username ?? "");
      }
        ...
        right={
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <Link
              ...
              style={{ height: 38, display: "inline-flex", alignItems: "center", gap: 5, fontSize: 13, whiteSpace: "nowrap" }}
            >
              ✏️ Modifica profilo
            </Link>
